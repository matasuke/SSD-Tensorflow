...
from datasets import meat_master_to_tfrecords
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'meat_master':
        meat_master_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
